...
YiActionCamera.downloadFile = function (filePath, outputPath) {
    ...
    var fileHttpPath     = 'http://' + YiActionCamera.ip + filePath,
...
function setVf() {
    return client.sendAction(constant.action.SET_VF, function(data) {
        return data.msg_id == constant.action.SET_VF && data.hasOwnProperty('rval');
    }, '192.168.42.122', 'TCP');
}
